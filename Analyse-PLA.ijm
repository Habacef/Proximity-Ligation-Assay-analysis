...
// This code allows retrieval of information about; PLA-events in nuclei (in nuclei that are not on the edges of the image); All PLA-events; All PLA-events that are cytoplasmic. 
